...
Establish a stable baseline around the parts of `Lengrvis-code-bast` that later autonomy work is most likely to touch:
...
3. `LENGRVIS_CODE_DISABLE_CLAUDE_MDS` suppresses `claudeMd`.
