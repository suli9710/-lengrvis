---
title: "流式响应机制 - Lengrvis Code 打字机效果原理"
description: "解析 Lengrvis Code 流式响应实现：如何通过 SSE 逐 token 接收 AI 输出，实现实时打字机效果，提升用户等待体验。"
...
| 场景 | stop_reason | 处理方式 |
|------|------------|----------|
| **输出超限** | `max_tokens` | 生成错误消息，建议设置 `LENGRVIS_CODE_MAX_OUTPUT_TOKENS` |
