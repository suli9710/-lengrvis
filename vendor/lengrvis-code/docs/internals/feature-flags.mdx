...
description: "深入剖析 Lengrvis Code 的 88+ 个构建时 feature flags：bun:bundle 编译时门控机制，揭示被编译器删除的隐藏功能模块。"
...
Lengrvis Code 使用 Bun 打包器的 `bun:bundle` 模块提供编译时特性门控：
...
const SleepTool = feature('PROACTIVE') || feature('KAIROS')
  ? require('@lengrvis-code-best/builtin-tools/tools/SleepTool/SleepTool.js').SleepTool
  : null
```
...
const MonitorTool = feature('MONITOR_TOOL')
  ? require('@lengrvis-code-best/builtin-tools/tools/MonitorTool/MonitorTool.js').MonitorTool
  : null
```
