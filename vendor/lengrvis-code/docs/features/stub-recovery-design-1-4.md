...
- 修改 [src/cli/handlers/templateJobs.ts](</e:/Source_code/Lengrvis-code-bast/src/cli/handlers/templateJobs.ts:1>)
- 新增 `src/jobs/state.ts`
- 新增 `src/jobs/templates.ts`
- Phase 2 再改 [src/jobs/classifier.ts](</e:/Source_code/Lengrvis-code-bast/src/jobs/classifier.ts:1>)
...
- attach 主流程其实已经存在：
  [src/main.tsx](</e:/Source_code/Lengrvis-code-bast/src/main.tsx:4708>)
- 远端 viewer 所需基础模块已存在：
  [src/remote/RemoteSessionManager.ts](</e:/Source_code/Lengrvis-code-bast/src/remote/RemoteSessionManager.ts:1>)
  [src/hooks/useAssistantHistory.ts](</e:/Source_code/Lengrvis-code-bast/src/hooks/useAssistantHistory.ts:1>)
  [src/assistant/sessionHistory.ts](</e:/Source_code/Lengrvis-code-bast/src/assistant/sessionHistory.ts:1>)
- 真正 stub 的主要是：
  [src/assistant/sessionDiscovery.ts](</e:/Source_code/Lengrvis-code-bast/src/assistant/sessionDiscovery.ts:1>)
  [src/assistant/AssistantSessionChooser.ts](</e:/Source_code/Lengrvis-code-bast/src/assistant/AssistantSessionChooser.ts:1>)
  [src/commands/assistant/assistant.ts](</e:/Source_code/Lengrvis-code-bast/src/commands/assistant/assistant.ts:7>)
  [src/assistant/index.ts](</e:/Source_code/Lengrvis-code-bast/src/assistant/index.ts:1>)
...
- Phase 4A：
  - [src/main.tsx](</e:/Source_code/Lengrvis-code-bast/src/main.tsx:4708>)
  - [src/commands/assistant/index.ts](</e:/Source_code/Lengrvis-code-bast/src/commands/assistant/index.ts:1>)
- Phase 4B：
  - [src/assistant/sessionDiscovery.ts](</e:/Source_code/Lengrvis-code-bast/src/assistant/sessionDiscovery.ts:1>)
- Phase 4C：
  - [src/assistant/AssistantSessionChooser.ts](</e:/Source_code/Lengrvis-code-bast/src/assistant/AssistantSessionChooser.ts:1>)
