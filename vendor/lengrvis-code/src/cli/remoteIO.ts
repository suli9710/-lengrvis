...
export class RemoteIO extends StructuredIO {
  ...
  constructor(
    ...
    const erVersion = process.env.LENGRVIS_CODE_ENVIRONMENT_RUNNER_VERSION
    if (erVersion) {
    ...
    const refreshHeaders = (): Record<string, string> => {
      ...
      const freshErVersion = process.env.LENGRVIS_CODE_ENVIRONMENT_RUNNER_VERSION
      if (freshErVersion) {
    ...
    this.isBridge = process.env.LENGRVIS_CODE_ENVIRONMENT_KIND === 'bridge'
