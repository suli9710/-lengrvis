...
import { REMOTE_TRIGGER_TOOL_NAME } from '@lengrvis-code-best/builtin-tools/tools/RemoteTriggerTool/prompt.js'
...
export function registerScheduleRemoteAgentsSkill(): void {
  registerBundledSkill({
    ...
    whenToUse:
      'When the user wants to schedule a recurring remote agent, set up automated tasks, create a cron job for Lengrvis Code, or manage their scheduled agents/triggers.',
    userInvocable: true,
    isEnabled: () =>
