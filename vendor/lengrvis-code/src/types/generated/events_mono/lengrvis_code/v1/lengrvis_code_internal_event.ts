...
//   protoc               unknown
// source: events_mono/lengrvis_code/v1/lengrvis_code_internal_event.proto
...
export interface EnvironmentMetadata {
  ...
  is_lengrvis_code_action?: boolean | undefined
  ...
  is_lengrvis_code_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  lengrvis_code_container_id?: string | undefined
  lengrvis_code_remote_session_id?: string | undefined
 ...
 * LengrvisCodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * LengrvisCodeInternalEvent represents events logged from Lengrvis Code via Statsig
 ...
 */
export interface LengrvisCodeInternalEvent {
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    arch: '',
    is_lengrvis_code_remote: false,
    remote_environment_type: '',
    lengrvis_code_container_id: '',
    lengrvis_code_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_lengrvis_code_action: isSet(object.is_lengrvis_code_action)
        ? globalThis.Boolean(object.is_lengrvis_code_action)
        : false,
      ...
      is_lengrvis_code_remote: isSet(object.is_lengrvis_code_remote)
        ? globalThis.Boolean(object.is_lengrvis_code_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      lengrvis_code_container_id: isSet(object.lengrvis_code_container_id)
        ? globalThis.String(object.lengrvis_code_container_id)
        : '',
      lengrvis_code_remote_session_id: isSet(object.lengrvis_code_remote_session_id)
        ? globalThis.String(object.lengrvis_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_lengrvis_code_action !== undefined) {
      obj.is_lengrvis_code_action = message.is_lengrvis_code_action
    }
    ...
    if (message.is_lengrvis_code_remote !== undefined) {
      obj.is_lengrvis_code_remote = message.is_lengrvis_code_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.lengrvis_code_container_id !== undefined) {
      obj.lengrvis_code_container_id = message.lengrvis_code_container_id
    }
    if (message.lengrvis_code_remote_session_id !== undefined) {
      obj.lengrvis_code_remote_session_id = message.lengrvis_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_lengrvis_code_action = object.is_lengrvis_code_action ?? false
    ...
    message.is_lengrvis_code_remote = object.is_lengrvis_code_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.lengrvis_code_container_id = object.lengrvis_code_container_id ?? ''
    message.lengrvis_code_remote_session_id =
      object.lengrvis_code_remote_session_id ?? ''
...
function createBaseLengrvisCodeInternalEvent(): LengrvisCodeInternalEvent {
  return {
    event_name: '',
...
export const LengrvisCodeInternalEvent: MessageFns<LengrvisCodeInternalEvent> = {
  fromJSON(object: any): LengrvisCodeInternalEvent {
    return {
  ...
  toJSON(message: LengrvisCodeInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<LengrvisCodeInternalEvent>, I>>(
    base?: I,
  ): LengrvisCodeInternalEvent {
    return LengrvisCodeInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<LengrvisCodeInternalEvent>, I>>(
    object: I,
  ): LengrvisCodeInternalEvent {
    const message = createBaseLengrvisCodeInternalEvent()
