...
import { isBriefEntitled } from '@lengrvis-code-best/builtin-tools/tools/BriefTool/BriefTool.js'
import { BRIEF_TOOL_NAME } from '@lengrvis-code-best/builtin-tools/tools/BriefTool/prompt.js'
import type {
  Command,
