...
export async function initReplBridge(
  ...
  // The env-based path below can ALSO use CCR v2 via LENGRVIS_CODE_USE_CCR_V2.
  ...
  let workerType: BridgeWorkerType = 'lengrvis_code'
  if (feature('KAIROS')) {
    ...
    if (isAssistantMode()) {
      workerType = 'lengrvis_code_assistant'
    }
  }
