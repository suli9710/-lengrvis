...
/**
 * The JSON Schema URL for Lengrvis Code settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/lengrvis-code-settings.json
 */
export const LENGRVIS_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/lengrvis-code-settings.json'
