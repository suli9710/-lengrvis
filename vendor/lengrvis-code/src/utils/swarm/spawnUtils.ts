...
const TEAMMATE_ENV_VARS = [
  ...
  'LENGRVIS_CODE_REMOTE_MEMORY_DIR',
 ...
 * Always includes LENGRVISCODE=1 and LENGRVIS_CODE_EXPERIMENTAL_AGENT_TEAMS=1,
...
export function getInheritedEnvVarAssignments(): Array<[string, string]> {
  const envVars: Array<[string, string]> = [
    ['LENGRVISCODE', '1'],
    ['LENGRVIS_CODE_EXPERIMENTAL_AGENT_TEAMS', '1'],
  ]
