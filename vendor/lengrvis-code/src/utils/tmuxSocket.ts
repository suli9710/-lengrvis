...
async function doInitialize(): Promise<void> {
  ...
  // Pass LENGRVIS_CODE_SKIP_PROMPT_HISTORY via -e so it's set in the initial shell environment
  //
  ...
  const result = await execTmux([
    ...
    'base',
    '-e',
    'LENGRVIS_CODE_SKIP_PROMPT_HISTORY=true',
    ...(getPlatform() === 'windows'
  ...
  // Set LENGRVIS_CODE_SKIP_PROMPT_HISTORY in the tmux GLOBAL environment (-g).
  ...
  // Any Lengrvis Code instance spawned on this socket will inherit this env var,
  ...
  await execTmux([
    ...
    'set-environment',
    '-g',
    'LENGRVIS_CODE_SKIP_PROMPT_HISTORY',
    'true',
  ])
