...
/**
 * Resolve Lengrvis Code-specific path patterns for sandbox-runtime.
 *
 * Lengrvis Code uses special path prefixes in permission rules:
...
/**
 * Convert Lengrvis Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Lengrvis Code started)
...
// scrubbed if they appear after a sandboxed command. See anthropics/lengrvis-code#29316.
 ...
 * bareGitRepoFiles. anthropics/lengrvis-code#29316.
 */
