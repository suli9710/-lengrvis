 ...
 * @param teamName - Optional team name (defaults to LENGRVIS_CODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's LENGRVIS_CODE_AGENT_ID */
  workerId: string
  /** Worker's LENGRVIS_CODE_AGENT_NAME */
  workerName: string
  /** Worker's LENGRVIS_CODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to LENGRVIS_CODE_TEAM_NAME env var)
