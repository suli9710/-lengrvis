 ...
 * variables instead: LENGRVIS_CODE_AGENT_ID, LENGRVIS_CODE_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from LENGRVIS_CODE_PARENT_SESSION_ID env var), undefined for main REPL subagents */
