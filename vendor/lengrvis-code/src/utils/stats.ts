...
/**
 * Convert a PersistedStatsCache to LengrvisCodeStats by computing derived fields.
 */
function cacheToStats(
  ...
  const result: LengrvisCodeStats = {
    totalSessions,
    totalMessages,
    totalDays,
...
/**
 * Aggregates stats from all Lengrvis Code sessions across all projects.
 * Uses a disk cache to avoid reprocessing historical data.
 */
export async function aggregateLengrvisCodeStats(): Promise<LengrvisCodeStats> {
 ...
 */
export async function aggregateLengrvisCodeStatsForRange(
  range: StatsDateRange,
): Promise<LengrvisCodeStats> {
  if (range === 'all') {
    return aggregateLengrvisCodeStats()
  }
  ...
  return processedStatsToLengrvisCodeStats(stats)
}

/**
 * Convert ProcessedStats to LengrvisCodeStats.
 * Used for filtered date ranges that bypass the cache.
 */
function processedStatsToLengrvisCodeStats(
...
function getEmptyStats(): LengrvisCodeStats {
  return {
    totalSessions: 0,
    totalMessages: 0,
    totalDays: 0,
