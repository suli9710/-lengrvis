...
import { getImageProcessor } from '@lengrvis-code-best/builtin-tools/tools/FileReadTool/imageProcessor.js'
...
function getClipboardCommands() {
  ...
  // Use LENGRVIS_CODE_TMPDIR if set, otherwise fall back to platform defaults
  const baseTmpDir =
