...
import { extractBashCommentLabel } from '@lengrvis-code-best/builtin-tools/tools/BashTool/commentLabel.js'
...
import { REPL_TOOL_NAME } from '@lengrvis-code-best/builtin-tools/tools/REPLTool/constants.js'
import { getReplPrimitiveTools } from '@lengrvis-code-best/builtin-tools/tools/REPLTool/primitiveTools.js'
import {
  type BranchAction,
  type CommitKind,
  detectGitOperation,
  type PrAction,
} from '@lengrvis-code-best/builtin-tools/tools/shared/gitOperationTracking.js'
...
const SNIP_TOOL_NAME = feature('HISTORY_SNIP')
  ? (
      require('@lengrvis-code-best/builtin-tools/tools/SnipTool/prompt.js') as typeof import('@lengrvis-code-best/builtin-tools/tools/SnipTool/prompt.js')
    ).SNIP_TOOL_NAME
  : null
