 ...
 * rationale. Env var: LENGRVIS_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'LENGRVIS_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
