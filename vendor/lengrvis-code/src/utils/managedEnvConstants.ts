 ...
 *
 * When LENGRVIS_CODE_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'LENGRVIS_CODE_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  ...
  'LENGRVIS_CODE_SKIP_BEDROCK_AUTH',
  'LENGRVIS_CODE_SKIP_VERTEX_AUTH',
  'LENGRVIS_CODE_SKIP_FOUNDRY_AUTH',
  'GEMINI_API_KEY',
 ...
 * These are Lengrvis Code specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'LENGRVIS_CODE_API_KEY_HELPER_TTL_MS',
  'LENGRVIS_CODE_DISABLE_EXPERIMENTAL_BETAS',
  'LENGRVIS_CODE_DISABLE_NONESSENTIAL_TRAFFIC',
  'LENGRVIS_CODE_DISABLE_TERMINAL_TITLE',
  'LENGRVIS_CODE_ENABLE_TELEMETRY',
  'LENGRVIS_CODE_EXPERIMENTAL_AGENT_TEAMS',
  'LENGRVIS_CODE_IDE_SKIP_AUTO_INSTALL',
