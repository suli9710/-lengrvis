 ...
 *
 * These helpers identify whether this Lengrvis Code instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.LENGRVIS_CODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our LENGRVIS_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no LENGRVIS_CODE_AGENT_ID set (backwards compat: the original
