...
export const MACOS_BUNDLE_ID = 'com.anthropic.lengrvis-code-url-handler'
const APP_NAME = 'Lengrvis Code URL Handler'
const DESKTOP_FILE_NAME = 'lengrvis-code-url-handler.desktop'
const MACOS_APP_NAME = 'Lengrvis Code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Lengrvis Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Lengrvis Code
