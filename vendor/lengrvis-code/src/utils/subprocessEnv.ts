...
const GHA_SUBPROCESS_SCRUB = [
  ...
  // lengrvis-code-action-specific duplicates — action JS consumes these during
 ...
 * servers, shell hooks).
 *
 * Gated on LENGRVIS_CODE_SUBPROCESS_ENV_SCRUB. lengrvis-code-action sets this
...
export function subprocessEnv(): NodeJS.ProcessEnv {
  ...
  if (!isEnvTruthy(process.env.LENGRVIS_CODE_SUBPROCESS_ENV_SCRUB)) {
