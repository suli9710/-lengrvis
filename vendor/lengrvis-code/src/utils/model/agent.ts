...
export function getAgentModel(
  ...
  if (process.env.LENGRVIS_CODE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.LENGRVIS_CODE_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/lengrvis-code/issues/30815.
 *
