...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Lengrvis Code was first started on this machine
  ...
  // Lengrvis Code usage tracking
  lengrvisCodeFirstTokenDate?: string // ISO timestamp of the user's first Lengrvis Code OAuth token
  ...
  // Lengrvis Code hint protocol state (<lengrvis-code-hint /> tags from CLIs/SDKs).
  ...
  // Disk cache for /api/lengrvis_code/organizations/metrics_enabled.
