...
import {
  type MCPProgress,
  MCPTool,
} from '@lengrvis-code-best/builtin-tools/tools/MCPTool/MCPTool.js'
import { createMcpAuthTool } from '@lengrvis-code-best/builtin-tools/tools/McpAuthTool/McpAuthTool.js'
...
} from '@lengrvis-code-best/mcp-client'
import { recursivelySanitizeUnicode } from '@lengrvis-code-best/mcp-client'
...
import { classifyMcpToolForCollapse } from '@lengrvis-code-best/builtin-tools/tools/MCPTool/classifyForCollapse.js'
    ...
    try {
      ...
      if (serverRef.type === 'sse') {
        ...
        const wsHeaders = {
          'User-Agent': getMCPUserAgent(),
          ...(serverRef.authToken && {
            'X-Lengrvis-Code-Ide-Authorization': serverRef.authToken,
          }),
        }
        ...
        const finalCommand =
          process.env.LENGRVIS_CODE_SHELL_PREFIX || stdioRef.command
        const finalArgs = process.env.LENGRVIS_CODE_SHELL_PREFIX
          ...
          return {
            ...
            async call(
              ...
              const meta = toolUseId
                ? { 'lengrviscode/toolUseId': toolUseId }
                : {}
