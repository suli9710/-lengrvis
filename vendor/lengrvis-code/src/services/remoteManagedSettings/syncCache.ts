 ...
 *   LENGRVIS_CODE_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Externally-injected tokens (CCD via LENGRVIS_CODE_OAUTH_TOKEN, CCR via
  // LENGRVIS_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
