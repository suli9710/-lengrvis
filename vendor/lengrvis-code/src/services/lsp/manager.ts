 ...
 * Initialized during Lengrvis Code startup.
 */
 ...
 * asynchronously during Lengrvis Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Lengrvis Code startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/lengrvis-code/issues/15521:
 ...
 *
 * This should be called during Lengrvis Code shutdown. Stops all running LSP servers
