...
const WORKFLOWS: WorkflowOption[] = [
  {
    ...
    label: '@Lengrvis Code - Tag @claude in issues and PR comments',
  },
  {
    value: 'claude-review' as const,
    label: 'Lengrvis Code Review - Automated code review on new PRs',
  },
];
    ...
    >
      <Box>
        <Text dimColor>
          ...
          <Link url="https://github.com/anthropics/lengrvis-code-action/blob/main/examples/">
            https://github.com/anthropics/lengrvis-code-action/blob/main/examples/
          </Link>
        </Text>
      </Box>
