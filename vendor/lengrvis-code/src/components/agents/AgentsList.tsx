...
import type { ResolvedAgent } from '@lengrvis-code-best/builtin-tools/tools/AgentTool/agentDisplay.js';
import {
  AGENT_SOURCE_GROUPS,
  compareAgentsByName,
  getOverrideSourceLabel,
  resolveAgentModelDisplay,
} from '@lengrvis-code-best/builtin-tools/tools/AgentTool/agentDisplay.js';
