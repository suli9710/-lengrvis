...
import type { AgentDefinitionsResult } from '@lengrvis-code-best/builtin-tools/tools/AgentTool/loadAgentsDir.js';
import type {
  AssistantMessage,
...
const SEND_USER_FILE_TOOL_NAME: string | null = feature('KAIROS')
  ? (
      require('@lengrvis-code-best/builtin-tools/tools/SendUserFileTool/prompt.js') as typeof import('@lengrvis-code-best/builtin-tools/tools/SendUserFileTool/prompt.js')
