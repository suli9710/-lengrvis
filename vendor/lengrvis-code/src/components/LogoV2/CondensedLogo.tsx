...
export function CondensedLogo(): ReactNode {
  ...
  // Truncate version to fit within available width, accounting for "Lengrvis Code v" prefix
  const versionPrefix = 'Lengrvis Code v';
    ...
    <OffscreenFreeze>
      <Box flexDirection="row" gap={2} alignItems="center">
        ...
        <Box flexDirection="column">
          <Text>
            <Text bold>Lengrvis Code</Text> <Text dimColor>v{truncatedVersion}</Text>
          </Text>
          {shouldSplit ? (
            <>
