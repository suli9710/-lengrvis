...
import { PowerShellTool } from '@lengrvis-code-best/builtin-tools/tools/PowerShellTool/PowerShellTool.js';
...
const ReviewArtifactTool = feature('REVIEW_ARTIFACT')
  ? (
      require('@lengrvis-code-best/builtin-tools/tools/ReviewArtifactTool/ReviewArtifactTool.js') as typeof import('@lengrvis-code-best/builtin-tools/tools/ReviewArtifactTool/ReviewArtifactTool.js')
    ).ReviewArtifactTool
  : null;
...
const WorkflowTool = feature('WORKFLOW_SCRIPTS')
  ? (
      require('@lengrvis-code-best/builtin-tools/tools/WorkflowTool/WorkflowTool.js') as typeof import('@lengrvis-code-best/builtin-tools/tools/WorkflowTool/WorkflowTool.js')
    ).WorkflowTool
  : null;

const WorkflowPermissionRequest = feature('WORKFLOW_SCRIPTS')
  ? (
      require('@lengrvis-code-best/builtin-tools/tools/WorkflowTool/WorkflowPermissionRequest.js') as typeof import('@lengrvis-code-best/builtin-tools/tools/WorkflowTool/WorkflowPermissionRequest.js')
    ).WorkflowPermissionRequest
  : null;

const MonitorTool = feature('MONITOR_TOOL')
  ? (
      require('@lengrvis-code-best/builtin-tools/tools/MonitorTool/MonitorTool.js') as typeof import('@lengrvis-code-best/builtin-tools/tools/MonitorTool/MonitorTool.js')
    ).MonitorTool
  : null;
...
function getNotificationMessage(toolUseConfirm: ToolUseConfirm): string {
  ...
  if (toolUseConfirm.tool === ExitPlanModeV2Tool) {
    return 'Lengrvis Code needs your approval for the plan';
  }

  if (toolUseConfirm.tool === EnterPlanModeTool) {
    return 'Lengrvis Code wants to enter plan mode';
  }
  ...
  if (!toolName || toolName.trim() === '') {
    return 'Lengrvis Code needs your attention';
  }
