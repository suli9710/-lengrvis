...
import type { AllowedPrompt } from '@lengrvis-code-best/builtin-tools/tools/ExitPlanModeTool/ExitPlanModeV2Tool.js';
...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: 'No, refine with Ultraplan on Lengrvis Code on the web',
      value: 'ultraplan',
    });
  }
