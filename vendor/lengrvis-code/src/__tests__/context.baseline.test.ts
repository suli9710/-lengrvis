...
beforeEach(async () => {
  ...
  delete process.env.LENGRVIS_CODE_DISABLE_CLAUDE_MDS
})
...
describe('context baseline', () => {
  ...
  test('LENGRVIS_CODE_DISABLE_CLAUDE_MDS suppresses claudeMd loading', async () => {
    process.env.LENGRVIS_CODE_DISABLE_CLAUDE_MDS = '1'
