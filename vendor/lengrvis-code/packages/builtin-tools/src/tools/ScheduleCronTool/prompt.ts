 ...
 * LENGRVIS_CODE_DISABLE_NONESSENTIAL_TRAFFIC are set; a `false` default would
 ...
 *
 * `LENGRVIS_CODE_DISABLE_CRON` is a local override that wins over GB.
 */
export function isKairosCronEnabled(): boolean {
  return !isEnvTruthy(process.env.LENGRVIS_CODE_DISABLE_CRON)
}
 ...
 * durable cron. Does NOT consult LENGRVIS_CODE_DISABLE_CRON (that kills the whole
