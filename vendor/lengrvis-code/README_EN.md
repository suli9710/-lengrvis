...
A reverse-engineered / decompiled source restoration of Anthropic's official [Lengrvis Code](https://docs.anthropic.com/en/docs/lengrvis-code) CLI tool. The goal is to reproduce most of Lengrvis Code's functionality and engineering capabilities. It's abbreviated as CCB.
...
- Standard Lengrvis Code configuration — each provider has its own setup method
...
- **DeepWiki**: https://deepwiki.com/lengrvis-code-best/lengrvis-code

## Contributors

<a href="https://github.com/lengrvis-code-best/lengrvis-code/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=lengrvis-code-best/lengrvis-code" />
</a>
...
<a href="https://www.star-history.com/?repos=lengrvis-code-best%2Flengrvis-code&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=lengrvis-code-best%2Flengrvis-code&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=lengrvis-code-best%2Flengrvis-code&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=lengrvis-code-best%2Flengrvis-code&type=date&legend=top-left" />
 </picture>
</a>

## License

This project is for educational and research purposes only. All rights to Lengrvis Code belong to [Anthropic](https://www.anthropic.com/).
