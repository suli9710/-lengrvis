...
| Decision | `the named v0.1.2 candidate snapshot is stale for the current dirty worktree; public Beta and release remain blocked because candidate-bound threat-model review, CI results, real LLM quality evidence, clean-machine/manual evidence, and owner sign-off are pending` |
