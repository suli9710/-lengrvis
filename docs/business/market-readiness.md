...
`evidence:commercial-operations-seal` Ed25519-seals completed reviewed commercial operations JSON with the reviewer-only private key and verifies it with the configured public key; it refuses templates and is not launch sign-off.
