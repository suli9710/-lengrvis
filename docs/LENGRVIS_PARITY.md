...
- Focused mobile/remote evidence: `python -m pytest backend/tests/test_mobile_pairing.py backend/tests/test_remote_desktop.py -q` (2026-06-09 historical targeted combined run; source/client smokes are supporting evidence, not real-device LAN/WSS proof; scheduler/preflight counts need an exact command/log before citation)
