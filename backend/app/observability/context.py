...
_request_id: ContextVar[str | None] = ContextVar("lengrvis_request_id", default=None)
_trace_id: ContextVar[str | None] = ContextVar("lengrvis_trace_id", default=None)
_span_id: ContextVar[str | None] = ContextVar("lengrvis_span_id", default=None)
...
def set_span_id(value: str | None) -> Token:
