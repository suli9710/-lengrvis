...
- Be deterministic and conservative around risk model compatibility, approval gates, model-authored runtime control fields, write concurrency, orchestrator size, externally copied source, and missing failure tests.
